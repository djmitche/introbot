...
* download this project (use the download link in github) and untar/unzip it
...
* open @introbot/actions.py@ and edit it.  Don't look at the other files - they
  are not introductory-level.
...
* Use the
 "random.choice":http://docs.python.org/library/random.html#random.choice
 function to choose a random quote on request
